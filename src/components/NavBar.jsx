      ...
      <div className="flex items-center justify-between px-4 lg:px-8 h-14">
        ...
        <div className={isMenuOpen ? "flex flex-col items-center gap-4 mt-6 lg:mt-0 lg:flex-row" : "hidden lg:flex items-center gap-4"}>
          ...
          {token === null && (
            <>
              <Link to={"/login"}>
                <button className="px-4 py-2 bg-gray-800 hover:bg-gray-700 border border-gray-700 rounded-lg text-sm">
                  Log In
                </button>
              </Link>

              <Link to={"/signup"}>
                <button className="px-4 py-2 bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg text-sm">
                  Sign Up
                </button>
              </Link>
            </>
