                ...
                {loading ? (
                    ...
                    <div className="bg-gray-900 p-8 rounded-lg shadow-md border-[1px] border-gray-800">
                        ...
                        <form action="" onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <button className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-slate-800 bg-yellow-300 hover:bg-yellow-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                                type='submit'>
                        ...
                        <div className="mt-6 text-center">
                            <Link to={"/login"} className="text-sm text-gray-400 hover:text-gray-200 hover:underline">
                                <p>Back to Login</p>
                            </Link>
                        </div>
                    </div>
